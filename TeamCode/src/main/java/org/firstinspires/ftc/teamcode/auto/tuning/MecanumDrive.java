...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.0015486727997805806;
        public double trackWidthTicks = 6666.66705125099;
...
//        public double kA = 0.00005;
        ...
        public double kV = 0.000374;
        public double kA = 0.00009;

        // path profile parameters (in inches)
        public double maxWheelVel = 72;//50
        public double minProfileAccel = -57;//-40
        public double maxProfileAccel = 70;//60
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        localizer = new PinpointLocalizer(srsHubs, pose);
    ...
    public TrajectoryActionBuilder actionBuilderBlue(Pose2d beginPose) {
        return new TrajectoryActionBuilder(
                TurnAction::new,
                FollowTrajectoryAction::new,
                new TrajectoryBuilderParams(
    ...
    public TrajectoryActionBuilder actionBuilderRed(Pose2d beginPose) {
        return new TrajectoryActionBuilder(
                TurnAction::new,
                FollowTrajectoryAction::new,
                new TrajectoryBuilderParams(
