...
@Config
@TeleOp(name = "Close Auto", group = "Teleop")
public class CloseAuto extends LinearOpMode {
    ...
    // INITIAL
    public static Pose2d initialCloseBluePose = new Pose2d(55, 51, Math.toRadians(90));
    public static Pose2d initialCloseRedPose = new Pose2d (55,-50, Math.toRadians(-90));
...
//    public static Pose2d leave = new Pose2d(-24, 12, Math.toRadians(0));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        MecanumDrive drive = new MecanumDrive(hardwareMap, initialCloseBluePose);

        Action blueAuto = drive.actionBuilderBlue(drive.localizer.getPose())
...
//        Action intakeHPAndShoot = drive.actionBuilderBlue(initialFarBluePose)
                ...
                .strafeToConstantHeading(closeFirstShoot)
...
//                .strafeToLinearHeading(blueCloseIntake.position)
                .waitSeconds(1)
...
//                .stopAndAdd(bot.shootThreeAuto())
        ...
        Action redAuto = drive.actionBuilderRed(initialCloseRedPose)
                .stopAndAdd(new SequentialAction(
                                bot.enableShooter(),
                                new SleepAction(0.5),
                                bot.shootThreeAuto(),
...
//        Action intakeFarShootThree = drive.actionBuilderBlue(new Pose2d(closeShoot, Math.toRadians(120)))
        ...
        Bot.startingPos = Bot.startingPosition.CLOSE;
