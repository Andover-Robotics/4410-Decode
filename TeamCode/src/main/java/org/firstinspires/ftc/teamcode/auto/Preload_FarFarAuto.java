...
//        Action blueFarAutoOnlyHpPre = drive.actionBuilderBlue(Pos.initialFarBluePose)
...
//                    .stopAndAdd(bot.shootThreeAutoClose());
//                    .build();
//        Action redFarAutoOnlyHpPre = drive.actionBuilderRed(Pos.initialFarBluePose)
//
//
//
//                .afterTime(0.1, bot.enableShooter())
