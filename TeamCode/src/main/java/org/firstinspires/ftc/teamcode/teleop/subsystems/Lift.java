...
public class Lift {
    ...
    public static double WRAP_TOLERANCE_DEG = 40.0, MAX_ANALOG_VOLT = 3.3, kP = 0.0065, kI = 0.0, kD = 0.0, kF = 0, POSITION_TOLERANCE_DEG = 10.0, maxPower = 1, spoolRad = 14 * 0.75, liftWidth = 178;
    public static int up = -3100, lower = 2200, down = 0, balancing = -500, mid = -2000;
